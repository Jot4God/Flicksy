...
function Navbar() {
  ...
  return (
    <nav className="navbar">
      <button className="navbar-logo-container" onClick={() => navigate("/")}>
        <img
      ...
      <div className="navbar-library">
        <p className="navbar-section-title">YOUR LIBRARY</p>
        ...
        >
          ...
          <span className="navbar-count">42</span>
        </button>
        ...
        >
          ...
          <span className="navbar-count">188</span>
        </button>
        ...
        >
          ...
          <span className="navbar-count">156</span>
        </button>
        ...
        >
          ...
          <span className="navbar-count">23</span>
        </button>
      </div>
      ...
      <div className="navbar-bottom">
        <div className="invite-card">
          <div className="invite-card-top">
            ...
            <IconChevronRight size={20} className="invite-arrow" />
          </div>

          <h3>Invite friends</h3>

          <p>See what your friends are watching and rated.</p>
        </div>
